  ...
  return <motion.div initial={{
    ...
    transition: {
      ...
      <div className=" px-4 glass">
        ...
        {sports.length > 0 && <div className="flex flex-wrap gap-2 mb-4">
            {sports.map(sport => <span key={sport} className="text-xs px-2 py-1 bg-turfGreen/10 dark:bg-turfGold/10 rounded-full">
                {sport}
              </span>)}
          </div>}
