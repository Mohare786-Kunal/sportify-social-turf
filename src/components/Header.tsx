...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 glass py-4 px-6 md:px-12 transition-all duration-300">
      <nav className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <Link to="/turfs" className="font-medium hover:text-turfGreen dark:hover:text-turfGold transition-colors">
            Browse Turfs
          </Link>
        ...
        <div className="md:hidden glass mt-2 p-4 rounded-lg animate-fade-in">
          <div className="flex flex-col space-y-3">
            <Link 
              ...
              className="font-medium py-2 hover:text-turfGreen dark:hover:text-turfGold transition-colors"
            >
              Home
            </Link>
            <Link 
