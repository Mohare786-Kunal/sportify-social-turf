      ...
      <div className="relative min-h-screen z-20">
        ...
        <section className="min-h-screen flex flex-col justify-center items-center px-4 py-24">
          ...
          >
            ...
            >
              {headingText.split("").map((char, index) => (
                <motion.span
                  ...
                  className={`inline-block ${char === " " ? "mr-2" : ""} text-glow-dark`}
                >
                  {char}
                </motion.span>
              ))}
            ...
            <motion.p 
              className="text-lg lg:text-xl text-gray-200 mb-8 max-w-2xl mx-auto"
              variants={itemVariants}
            >
            ...
            <motion.div variants={itemVariants}>
              <Link to="/turfs">
                <Button 
                  size="lg" 
                  className="bg-turfGreen dark:bg-turfGold text-white dark:text-turfBlue hover:bg-turfGreen-dark dark:hover:bg-turfGold-dark transition-colors"
                >
                  Browse Turfs
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <FeatureCard 
                ...
                description="Book your turf effortlessly with our user-friendly interface. Pay online and receive instant confirmation."
                delay={0.1}
              />
              <FeatureCard 
                icon={<MessageCircle className="h-8 w-8" />}
                title="Community Chat"
                description="Connect with players, organize games, and find teammates in our community chat."
                delay={0.2}
              />
              <FeatureCard 
                icon={<CreditCard className="h-8 w-8" />}
                title="Secure Payments"
                description="Pay securely with Razorpay for a hassle-free experience. No hidden charges."
                delay={0.3}
              />
            </div>
          </div>
